...
const nft_market_place_address = "0x80633C5eE1050Cb354Ec19B0440c0621C023fBA3" ;
const coordinatorKey = "da1f8db6aa602fe7556ec5673e9651b2d49fcea7948d25d7125c5ef041e8bbf2";
[
	{
		"inputs": [
			{
...
Moralis.Cloud.define("placeOffering", async(request) => {
		const hostContract = request.params.hostContract;
			...
			const nonceOperator = web3.eth.getTransactionCount("0xB09674AD4E1E29158Dd5Af16E817a7f6f01eE16a")
